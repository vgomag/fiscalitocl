...
- Identifica TODAS, incluso las menores.`;
      ...
      /* Process up to 40K chars with higher token budget */
      const chunk = text.substring(0, 40000);
    ...
    return { statusCode: 200, headers: H, body: JSON.stringify({
      ...
      extractedText: txt.substring(0, 500000), aiSummary: null, charCount: txt.length
    })};
