/* =========================================================
   ...
   v9.0 · 2026-04-02 · Fiscalito / UMAG
   =========================================================
...
async function f11StartRecording(){
  try {
    ...
    _f11Recorder.onstop = () => {
      ...
      const mimeType = _f11Recorder.mimeType || 'audio/webm';
    ...
    if(recBtn){ recBtn.style.background='var(--red)'; recBtn.style.color='#fff'; }
  } catch(e){
...
/* ══════════════════ LOG ══════════════════ */
console.log('%c🎙️ Módulo F11 Transcripción v9.0 — UI 3 pasos unificada', 'color:#7c3aed;font-weight:bold');
console.log('%c   ✓ ElevenLabs/Whisper  ✓ Edición IA  ✓ Acta firmable', 'color:#666');
