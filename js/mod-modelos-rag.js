...
(function injectRAGSidebarItem() {
  ...
  const plantillas = [...document.querySelectorAll('.sidebar-nav-item')]
    .find(el => el.getAttribute('onclick')?.includes('openPlantillasPersonalizadas'));
  ...
  plantillas.insertAdjacentElement('afterend', item);
})();
